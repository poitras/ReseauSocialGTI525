...
return array(
    ...
    */
     ...
     'domain'        => 'gti525-social-network.auth0.com',
    /*
    |--------------------------------------------------------------------------
    |   Your APP id
    |--------------------------------------------------------------------------
    ...
    */
     ...
     'client_id'     => '5Ah9L4goYBwN5LanrnWYZex9NKSA3rJn',
    ...
    |
    */
     'client_secret' => 'biKV-FgMqD9zC842_LZ4XOnvVgG4SaC9NT4Yz6Z5FzwTi33WgWgYz1quVpbMI6li',
    ...
    */
     ...
     'redirect_uri'  => 'http://social-network.dev/api/vi/auth0/callback',
